/*The bug that I found was the in the function foo, there was a missing else clause after if. 
Because of that, even if there was an error, It would still call the callback and display the results. 
However, the currect behavior of the function should that if there's any error, 
